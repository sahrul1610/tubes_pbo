...
public class StarfishMenu implements Screen {
    ...
    public void create(){
        ...
        background.setTexture( new
                Texture(Gdx.files.internal("water2.jpg")) );
        uiStage.addActor( background );
        BaseActor titleText = new BaseActor();
        titleText.setTexture( new
                Texture(Gdx.files.internal("starfish-collector.png")) );
        titleText.setPosition( 60, 100 );
    ...
    public void render(float dt){
        ...
        if (Gdx.input.isKeyPressed(Keys.S))
            game.setScreen( new StarfishLevel(game) );
        // update
        uiStage.act(dt);
        // draw graphics
